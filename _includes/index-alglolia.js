window.addEventListener('load', function () {
  ...
  search.addWidget(
    instantsearch.widgets.searchBox({
      ...
      placeholder: algoliaI18n.placeholder
    })
  );
    ...
    instantsearch.widgets.hits({
      ...
      templates: {
        empty: '<div class="hhome-cards">' +
            '<a class="card card-support" href="/help/' + locale + '/support">' +
              '<img src="/help/assets/img/home-email.svg">' +
              '<div class="t">' +
                '<h2>' + algoliaI18n.notFoundTitle + '</h2>' +
                '<div class="description">' + algoliaI18n.notFoundDescription + '</div>' +
              '</div>' +
            '</a>' +
          '</div>',
        item: function (hit) {
